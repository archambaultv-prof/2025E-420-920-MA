...
const config = {
  title: '2025E-420-920-MA',
  tagline: 'Concepts de programmation 2',
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/archambaultv-prof/2025E-420-920-MA/tree/main/',
        },
        blog: false,
        theme: {
